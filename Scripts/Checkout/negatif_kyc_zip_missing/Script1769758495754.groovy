...
WebUI.setText(findTestObject('Object Repository/Dashboard/field_checkout_zip'), '')

WebUI.click(findTestObject('Object Repository/Dashboard/btn_checkout_continue'))

WebUI.verifyElementText(findTestObject('Object Repository/Dashboard/error_kyc'), 'Error: Postal Code is required')
