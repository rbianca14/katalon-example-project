...
WebUI.setText(findTestObject('Object Repository/Dashboard/field_checkout_firstname'), '')

WebUI.setText(findTestObject('Object Repository/Dashboard/field_checkout_lastname'), 'rivera')
...
WebUI.verifyElementText(findTestObject('Object Repository/Dashboard/error_kyc'), 'Error: First Name is required')
